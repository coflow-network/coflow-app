...
export const getFlow = makeInterface(async (context, event) => {
...
export const fetchFlows = makeInterface(async (context, event) => {
  var {data, error} = {};
  if ( event.space === null ) {
...
export const createFlow = makeInterface(async (context, event) => {
